public class Game {         //BASE CLASS
    ...
    public boolean addRule(Rule r){
        ...
        // this if statement checks to see that rules has enough space remaining to accept another Rule, and returns false if it does not
